...
//  youareawesome
//
//  Created by BARRERA, LARRY on 11/4/25.
//
...
struct ContentView: View {
    ...
    @State private var lastMessageNumber = -1 //lastMessageNumber will nevr be -1
...
//generate a random messageNumber to use as an index
                //if messageNumber == lastMessageNumber { // keep generating a new random messageNumber
